...
### plot the differences in training error
...
plt.plot(diff_1, color = "red", linestyle = "-")
plt.plot(diff_2, color = "blue", linestyle = "--")
...
plt.title("", 
 	fontsize = 24)
plt.legend(["10% compression", "20% compression"], loc = "lower right",
	fontsize = 16)
plt.grid(True)
